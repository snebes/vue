...
( function() {
    ...
    CKEDITOR.plugins.cdpNumberedList = {
         ...
         *
         * @member CKEDITOR.plugins.cdpNumberedList
         * @todo params
         */
        listToArray: function( listNode, database, baseArray, baseIndentLevel, grandparentNode ) {
            ...
            for ( var i = 0, count = listNode.getChildCount(); i < count; i++ ) {
                ...
                if ( listItem.type == CKEDITOR.NODE_ELEMENT && listItem.getName() in CKEDITOR.dtd.$list )
                    CKEDITOR.plugins.cdpNumberedList.listToArray( listItem, database, baseArray, baseIndentLevel + 1 );
                ...
                for ( var j = 0, itemChildCount = listItem.getChildCount(), child; j < itemChildCount; j++ ) {
                    ...
                    // +1 indentation in the correct order.
                        CKEDITOR.plugins.cdpNumberedList.listToArray( child, database, baseArray, baseIndentLevel + 1, itemObj.grandparent );
                    else
            ...
            while ( 1 ) {
                ...
                if ( item.indent == indentLevel ) {
                    ...
                    var currDir = listArray[ currentIndex - 1 ].element.getDirection( 1 ),
                        listData = CKEDITOR.plugins.cdpNumberedList.arrayToList( listArray, null, currentIndex, paragraphMode, currDir != orgDir ? orgDir : null );
    ...
    function changeListType( editor, groupObj, database, listsCreated ) {
        ...
        var listArray = CKEDITOR.plugins.cdpNumberedList.listToArray( groupObj.root, database ),
            selectedListItems = [];
console.log(listArray);
        ...
        var newList = CKEDITOR.plugins.cdpNumberedList.arrayToList( listArray, database, null, editor.config.enterMode );
        var child,
    ...
    function removeList( editor, groupObj, database ) {
        ...
        var newList = CKEDITOR.plugins.cdpNumberedList.arrayToList( listArray, database, null, editor.config.enterMode, groupObj.root.getAttribute( 'dir' ) );
    ...
    CKEDITOR.plugins.add( 'cdpNumberedList', {
        ...
        init: function( editor ) {
            ...
            // Register commands.
            editor.addCommand( 'cdpNumberedlist', new listCommand( 'numberedlist', 'ol' ) );

            // Register the toolbar button.
            if ( editor.ui.addButton ) {
                editor.ui.addButton( 'NumberedList', {
                    label: editor.lang.list.cdpNumberedlist,
